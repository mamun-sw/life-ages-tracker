export type UiconName =
  ...
  | 'podium'
  | 'podium-star'
  | 'podium-victory-leader'
  | 'point-of-sale'
  | 'point-of-sale-bill'
  | 'point-of-sale-signal'
  | 'pointer-loading'
  | 'pointer-text'
  | 'poker-chip'
  | 'police-box'
